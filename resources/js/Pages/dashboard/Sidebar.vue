<template>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #000 !important">
    ...
    <!--<a href="index3.html" class="brand-link" style="text-align: center;">
     ...
     <Link class="brand-link" style="text-align: center;" href="/account" v-if="$page.props.is_employer == 1 || $page.props.is_candidate == 1 || $page.props.is_consult== 1 || $page.props.is_staff== 1"><img src="/img/LG-RIDD@2x.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8;float:unset !important;max-height: 90px !important;"></Link>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          ...
          <img src="/img/user.jpg" v-if="$page.props['image_profile']==''" class="img-circle elevation-2" alt="User Image">
        ...
        <div class="info" style="width: 200px;">
          <span>
            ...
            <Link href="/account/profile" v-if="$page.props.is_employer == 1 || $page.props.is_candidate == 1 || $page.props.is_consult== 1 || $page.props.is_staff== 1">{{ $page.props.user['first_name'] }}</Link>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <template v-if="$page.props.is_admin == 1 || $page.props.is_staff == 1">
	          ...
	          <li class="nav-item" v-if="$page.props.is_admin == 1 || $page.props.is_staff == 1">
	            <!--<a href="pages/widgets.html" class="nav-link">
	              <i class="nav-icon fas fa-th"></i>
	              <p>
	                Offres
