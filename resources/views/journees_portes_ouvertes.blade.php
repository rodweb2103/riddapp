...
<div class="row pswp-gallery" id="my-gallery">
      ...
      data-pswp-height="1667"
                    ...
                    @foreach(\File::glob(public_path() . '/img/Orientation/*.*') as $v)
	                
	                
	                   <div class="col-lg-4 col-md-6">
	                        <div class="courses-item">
		                        <a href="{{ asset('/img/Orientation/'.basename($v)) }}" class="fancybox" data-pswp-width="2500"
	      data-pswp-height="1667">
	                                <img src="{{ asset('/img/Orientation/'.basename($v)) }}"  alt="Courses"/>
		                        </a>
	                        </div>
                        </div>
